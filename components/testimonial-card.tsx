  ...
  return (
    <div className="relative flex flex-col items-start gap-2 p-3 h-[26em] w-[23rem] flex-shrink-0">
      ...
      <div className="relative flex items-center gap-2 rounded-3xl bg-yellow-100 px-5 py-2 shadow-sm">
        {/* Avatar Circle */}
        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-300 to-blue-400 text-lg shadow-md">
          {testimonial.avatar}
        </div>
      ...
      >
        ...
        <div className="flex items-center gap-3 mt-3">
          {/* Company Logo Circle */}
          <div className="flex h-10 w-10 items-center justify-center rounded-full border-4 border-dotted border-gray-800 bg-white">
            <span className="text-[10px] font-black text-gray-900">LOGO</span>
          </div>
